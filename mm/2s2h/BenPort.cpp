...
extern "C" __declspec(dllexport) void MM_RaiseSharedTier(int family, int tier) try {
    if (family < 0 || family >= ComboRando::SF_COUNT)
        return;
...
extern "C" __declspec(dllexport) void MM_SetSharedChangedCb(void (*cb)(int, int)) {
    gMMComboSharedChanged = cb;
}
extern "C" void (*gMMComboSharedTick)(void) = nullptr;
extern "C" __declspec(dllexport) void MM_SetSharedTickCb(void (*cb)(void)) {
