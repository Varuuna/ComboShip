# Merge pass 2026-06-03 — initial three-way merge (libultraship / soh / mm)

The first full upstream pull. Per-folder post-merge change log (every file we had to touch
after the mechanical 3-way merge, and why). For the mechanism + standing policies see
[../UPSTREAM_MERGES.md](../UPSTREAM_MERGES.md).
