...
const std::vector<FlagTable> flagTables = {
    ...
    { "Rando Inf",
      RANDO_INF,
      {
          ...
          RANDO_INF_ENTRY(RANDO_INF_OBTAINED_SONG_MINUET),
          RANDO_INF_ENTRY(RANDO_INF_OBTAINED_SONG_BOLERO),
          RANDO_INF_ENTRY(RANDO_INF_OBTAINED_SONG_SERENADE),
          RANDO_INF_ENTRY(RANDO_INF_OBTAINED_SONG_REQUIEM),
          RANDO_INF_ENTRY(RANDO_INF_OBTAINED_SONG_NOCTURNE),
          RANDO_INF_ENTRY(RANDO_INF_OBTAINED_SONG_PRELUDE),
#endif
      } },
};
