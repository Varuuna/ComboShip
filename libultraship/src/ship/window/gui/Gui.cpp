...
// Default no-op. The ImGui renderer backend lives in the Fast3D layer (Fast3dGui) in current
// upstream, so the actual font-texture invalidation is overridden there. See Fast3dGui::RebuildFontTexture.
