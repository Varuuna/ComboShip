...
// ComboShip: the Happy Mask Shop scene is the OOT->MM portal and never runs, so this check is
// uncollectable. Unregistered => in neither the item pool nor the check tracker.
#ifndef COMBO_BUILD
